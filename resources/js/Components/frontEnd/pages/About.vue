            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="about-block-item mb-5 mb-lg-0">
                        <img
                            src="/frontEnd/images/about/about-1.jpg"
                            alt=""
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="about-block-item mb-5 mb-lg-0">
                        <img
                            src="/frontEnd/images/about/about-2.jpg"
                            alt=""
                            class="img-fluid w-100"
                        />
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="about-block-item mb-5 mb-lg-0">
                        <img
                            src="/frontEnd/images/about/about-3.jpg"
                            alt=""
                            class="img-fluid w-100"
                        />
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="about-block-item">
                        <img
                            src="/frontEnd/images/about/about-4.jpg"
                            alt=""
                            class="img-fluid w-100"
                        />
                ...
                <div class="col-lg-8">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="award-img">
                                <img
                                    src="/frontEnd/images/about/3.png"
                                    alt=""
                                    class="img-fluid"
                                />
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="award-img">
                                <img
                                    src="/frontEnd/images/about/4.png"
                                    alt=""
                                    class="img-fluid"
                                />
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="award-img">
                                <img
                                    src="/frontEnd/images/about/1.png"
                                    alt=""
                                    class="img-fluid"
                                />
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="award-img">
                                <img
                                    src="/frontEnd/images/about/2.png"
                                    alt=""
                                    class="img-fluid"
                                />
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="award-img">
                                <img
                                    src="/frontEnd/images/about/5.png"
                                    alt=""
                                    class="img-fluid"
                                />
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="award-img">
                                <img
                                    src="/frontEnd/images/about/6.png"
                                    alt=""
                                    class="img-fluid"
                                />
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team-block mb-5 mb-lg-0">
                        <img
                            src="/frontEnd/images/team/1.jpg"
                            alt=""
                            class="img-fluid w-100"
                        />
                        <div class="content">
                            <h4 class="mt-4 mb-0">
                                <router-link to="/doctor-single">John Marshal</router-link>
                            </h4>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team-block mb-5 mb-lg-0">
                        <img
                            src="/frontEnd/images/team/2.jpg"
                            alt=""
                            class="img-fluid w-100"
                        />
                        <div class="content">
                            <h4 class="mt-4 mb-0">
                                <router-link to="/doctor-single">Marshal Root</router-link>
                            </h4>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team-block mb-5 mb-lg-0">
                        <img
                            src="/frontEnd/images/team/3.jpg"
                            alt=""
                            class="img-fluid w-100"
                        />
                        <div class="content">
                            <h4 class="mt-4 mb-0">
                                <router-link to="/doctor-single">Siamon John</router-link>
                            </h4>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team-block">
                        <img
                            src="/frontEnd/images/team/4.jpg"
                            alt=""
                            class="img-fluid w-100"
                        />
                        <div class="content">
                            <h4 class="mt-4 mb-0">
                                <router-link to="/doctor-single">Rishat Ahmed</router-link>
                            </h4>
